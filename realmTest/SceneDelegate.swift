...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if UserDefaults.standard.bool(forKey: "editing") {
            ...
            let vc = createNavigationController(storyboardName: "Main", storyboardId: "CurrentLogViewController")
            window.rootViewController = vc
        } else {
            
            let vc = createNavigationController(storyboardName: "Main", storyboardId: "StartViewController")
            window.rootViewController = vc
